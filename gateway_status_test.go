...
// func TestListenAndServe_With_NoProxies(t *testing.T) {
// 	var proxies []*Proxy
// 	gateway := Gateway{}

// 	err := gateway.ListenAndServe(proxies)

// 	if err == nil {
// 		t.Fail()
// 	}

// 	if err.Error() != "no proxies in gateway" {
// 		t.Fail()
// 	}

// }

// func TestListenAndServer_With_Proxies(t *testing.T) {
// 	gateway := Gateway{}
// 	defer gateway.Close()
// 	go func() {
...
// func TestConnWithChannels(t *testing.T) {
