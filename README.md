...
| onlineStatus      | Object  | false    | See [Response Status](#Response Status)        | This is the response that Infrared will give when a client asks for the server status and the server is online.                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
