...
func getPlayerHandler(api infrared.API) http.HandlerFunc {
	type respDTO struct {
		Username      infrared.Username  `json:"username" example:"H4v34ch1n"`
		GatewayID     infrared.GatewayID `json:"gatewayId" example:"default"`
		...
		ServerID      infrared.ServerID  `json:"serverId" example:"default"`
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		username := infrared.Username(chi.URLParam(r, "username"))
